          ...
          >
            <label className="flex flex-col">
              ...
              <input
                ...
                className="bg-tertiary py-4 px-6 text-white-100 placeholder:text-secondary rounded-lg outline-none border-none font-medium"
              />
            </label>
            ...
            <button
              type="submit"
              className="bg-tertiary py-3 px-8 rounded-xl outline-none text-white-100 font-bold w-fit shadow-md shadow-primary"
            >
